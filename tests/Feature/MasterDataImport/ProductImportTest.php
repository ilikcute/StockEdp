...
class ProductImportTest extends TestCase
{
    ...
    public function test_can_import_products_with_unit_price_formats(): void
    {
        $csvContent = "sku,barcode,name,description,category_code,unit_code,minimum_stock,unit_price\n"
            ."PRD-PR1,111,Barang Satu,,CAT-ELEC,UNIT-PCS,5,15000\n"
            ."PRD-PR2,222,Barang Dua,,CAT-ELEC,UNIT-PCS,0,15.000\n"
            ."PRD-PR3,333,Barang Tiga,,CAT-ELEC,UNIT-PCS,2,\"Rp 25.500,50\"\n"
            ."PRD-PR4,444,Barang Empat,,CAT-ELEC,UNIT-PCS,1,\n"
            ."PRD-PR5,555,Barang Lima,,CAT-ELEC,UNIT-PCS,10,125000.75\n";
        ...
        $valRes->assertOk()
            ...
            ->assertJsonPath('data.valid_rows', 5)
            ->assertJsonPath('data.invalid_rows', 0);
        ...
        $commitRes->assertCreated()
            ->assertJsonPath('data.imported_rows', 5);
