    ...
    <header class="bg-white border-b border-gray-100 shadow-2xs sticky top-0 z-30 pt-safe">
      <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-14 sm:h-16 flex items-center justify-between">
        <div class="flex items-center space-x-4 lg:space-x-8">
          ...
          >
            <span class="w-8 h-8 rounded-lg bg-indigo-600 text-white flex items-center justify-center text-xs font-black shadow-xs">
              EDP
            </span>
        ...
        <div class="flex items-center space-x-2 sm:space-x-3">
          ...
          <button
            v-if="authStore.isAuthenticated"
            type="button"
            class="lg:hidden p-2 rounded-lg text-gray-700 hover:text-indigo-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 cursor-pointer min-w-[40px] min-h-[40px] flex items-center justify-center"
