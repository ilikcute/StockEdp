<template>
  <nav class="hidden lg:flex items-center space-x-1">
    ...
    <router-link
      ...
      active-class="text-indigo-600 bg-indigo-50/50 font-semibold"
      @click="closeAllMenus"
    >
      Dashboard
    </router-link>
    ...
    >
      <button
        type="button"
        class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-indigo-600 hover:bg-gray-50 transition-colors"
        :class="{ 'text-indigo-600 bg-indigo-50/50': isInventoryActive }"
      ...
      >
        ...
        >
          <router-link
            ...
            active-class="bg-gray-100 text-indigo-600 font-medium"
            @click="closeAllMenus"
          >
            {{ item.label }}
          </router-link>
    ...
    >
      <button
        type="button"
        class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-indigo-600 hover:bg-gray-50 transition-colors"
        :class="{ 'text-indigo-600 bg-indigo-50/50': isReportActive }"
