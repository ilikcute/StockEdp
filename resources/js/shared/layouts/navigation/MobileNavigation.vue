<template>
  <div>
    ...
    >
      <!-- User Profile Header -->
      <div class="px-4 py-3 bg-gray-50/80 flex items-center justify-between gap-2">
        <div class="flex items-center gap-3">
          <div class="w-9 h-9 rounded-full bg-indigo-600 text-white font-bold flex items-center justify-center text-sm shadow-xs">
        ...
        <div class="flex items-center gap-1.5">
          ...
          <button
            type="button"
            class="px-2 py-1 text-xs font-semibold text-gray-600 bg-white hover:bg-gray-100 border border-gray-300 rounded-md transition-colors cursor-pointer"
      ...
      <div class="p-4 space-y-4">
        ...
        <div class="space-y-1">
          ...
          <router-link
            ...
            to="/dashboard"
            class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-semibold text-gray-700 hover:text-indigo-600 hover:bg-indigo-50/50 transition-colors"
        ...
        >
          ...
          >
            <router-link
              ...
              :to="item.to"
              class="flex items-center justify-between px-3 py-2 rounded-lg text-xs font-medium text-gray-700 hover:text-indigo-600 hover:bg-indigo-50/50 transition-colors"
              active-class="bg-indigo-50 text-indigo-600 font-bold"
              @click="emit('close')"
            >
