  ...
  >
    <div class="grid grid-cols-5 h-14 items-center justify-around px-1 max-w-md mx-auto">
      ...
      <router-link
        ...
        :class="isRouteActive('/dashboard') ? 'text-indigo-600 font-bold' : 'text-gray-500 hover:text-gray-900'"
      >
        <svg
      ...
      <router-link
        to="/products"
        class="flex flex-col items-center justify-center py-1 text-[10px] font-medium transition-colors"
        :class="isRouteActive(['/products', '/categories', '/units', '/suppliers', '/locations', '/stores', '/departments']) ? 'text-indigo-600 font-bold' : 'text-gray-500 hover:text-gray-900'"
      >
        <svg
          class="w-5 h-5 mb-0.5"
          fill="none"
      ...
      <router-link
        ...
        class="flex flex-col items-center justify-center py-1 text-[10px] font-medium transition-colors"
        :class="isRouteActive(['/reports']) ? 'text-indigo-600 font-bold' : 'text-gray-500 hover:text-gray-900'"
      >
        <svg
          class="w-5 h-5 mb-0.5"
          fill="none"
