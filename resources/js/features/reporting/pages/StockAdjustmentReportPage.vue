    ...
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        ...
        <p class="mt-2 text-sm text-gray-700">
          Daftar item penyesuaian stok yang sudah diposting.
        </p>
      </div>
    </div>
      ...
      <div class="flex flex-wrap gap-4 items-end">
        <div class="w-full sm:w-auto flex-1 min-w-[200px]">
          ...
          <input
            ...
            placeholder="Nomor adjustment, produk..."
          >
        </div>
      ...
      <div class="flex flex-wrap gap-4 items-end">
        ...
        <div class="flex gap-2">
          ...
          >
            ...
            <option value="adjustment_date">
              Tanggal Adjustment
            </option>
            <option value="adjustment_number">
              Nomor Adjustment
            </option>
            <option value="id">
              ID
              ...
              <table class="min-w-full divide-y divide-gray-300">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  <tr v-if="!store.loading && store.data.length === 0">
                    ...
                    >
                      Tidak ada data adjustment yang sesuai filter.
                    </td>
                  </tr>
                  <tr
