    ...
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        ...
        <p class="mt-2 text-sm text-gray-700">
          Daftar item penerimaan stok yang sudah diposting, dengan filter dan ringkasan dari server.
        </p>
      </div>
    </div>
      ...
      <div class="flex flex-wrap gap-4 items-end">
        <div class="w-full sm:w-auto flex-1 min-w-[200px]">
          ...
          <input
            ...
            placeholder="Nomor, produk, supplier..."
          >
        </div>
              ...
              <table class="min-w-full divide-y divide-gray-300">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  <tr v-if="!store.loading && store.data.length === 0">
                    ...
                    >
                      Tidak ada data penerimaan stok yang sesuai filter.
                    </td>
                  </tr>
                  <tr
...
const dateBasisDescription = computed(() => {
    if (store.meta?.date_basis === 'MOVEMENT_POSTED_AT') {
        return 'Periode laporan menggunakan waktu posting movement penerimaan.';
    }
