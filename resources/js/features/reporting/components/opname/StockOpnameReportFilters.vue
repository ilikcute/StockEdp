  ...
  <div class="rounded-xl bg-white p-2.5 border border-gray-200 shadow-2xs space-y-2.5">
    ...
    <div class="flex flex-wrap items-center justify-between gap-2">
      ...
      <div class="flex flex-wrap items-center gap-2 flex-1 min-w-0">
        ...
        <!-- Variance Direction Selector -->
        <div class="w-full sm:w-36">
          <select
            :value="filters.variance_direction"
            class="block w-full rounded-lg border border-gray-300 bg-white py-1.5 pl-2.5 pr-8 text-xs shadow-2xs focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 font-medium"
            title="Arah Selisih"
    ...
    >
      <!-- Filter Product Unexpected -->
      <div>
        <label class="block text-xs font-medium text-gray-700">Filter Unexpected</label>
        <select
...
const activeAdvancedCount = computed(() => {
    let c = 0;
    if (props.filters.is_unexpected !== '' && props.filters.is_unexpected !== undefined && props.filters.is_unexpected !== null) c++;
...
const isAnyFilterActive = computed(() => {
    return Boolean(
        ...
        props.filters.variance_direction ||
        (props.filters.is_unexpected !== '' && props.filters.is_unexpected !== undefined && props.filters.is_unexpected !== null) ||
