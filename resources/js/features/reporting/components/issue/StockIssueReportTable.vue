    ...
    <table class="w-full text-left text-xs border-collapse">
      ...
      <tbody class="divide-y divide-gray-100 bg-white">
        <BaseTableEmpty
          v-if="items.length === 0"
          :colspan="13"
          message="Tidak ada data pengeluaran barang"
        ...
        >
          ...
          <td class="py-1.5 px-2 text-[11px] text-gray-900 font-medium whitespace-nowrap">
            {{ item.purpose || '-' }}
          </td>
          ...
          <td class="py-1.5 px-2 text-[11px] font-mono text-right text-amber-700 font-semibold whitespace-nowrap">
