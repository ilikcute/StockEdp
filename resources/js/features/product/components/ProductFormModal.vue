          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                step="1"
                min="0"
                class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
                placeholder="0"
              >
            </div>
            ...
            <div>
              ...
              <div class="relative rounded-md shadow-xs">
                ...
                <input
                  ...
                  step="0.01"
                  min="0"
                  class="w-full pl-10 pr-3 py-2 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
                  :class="store.validationErrors?.unit_price ? 'border-red-500' : 'border-gray-300'"
                  placeholder="0"
                >
              </div>
              <p
