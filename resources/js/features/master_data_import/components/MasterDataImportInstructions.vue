    ...
    <div class="flex items-start justify-between gap-4">
      <div class="space-y-1">
        ...
        <ul class="text-xs text-blue-800 list-disc list-inside space-y-0.5">
          ...
          <li v-if="type === 'products'">
            Kolom <strong>unit_price</strong> (harga satuan) bersifat opsional. Mendukung angka murni maupun desimal (contoh: <code>15000</code> atau <code>15000.00</code>). Default 0 jika dikosongkan.
          </li>
        </ul>
      </div>
      <button
