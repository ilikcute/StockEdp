        ...
        <div class="overflow-x-auto">
          <table class="w-full text-left text-xs border-collapse">
            ...
            <tfoot
              ...
              class="bg-gray-50 font-semibold text-gray-900 border-t border-gray-200"
            >
              <tr>
                <td
                  colspan="4"
                  class="py-2.5 px-3 text-right text-xs"
                >
                  Grand Total Estimasi Nilai Transfer:
                </td>
                <td class="py-2.5 px-3 text-right font-mono text-xs text-indigo-700">
