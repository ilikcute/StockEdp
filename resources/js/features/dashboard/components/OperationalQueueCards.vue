  ...
  <div class="bg-white rounded-xl shadow-xs border border-gray-200 p-5">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
      ...
      <component
        ...
        type="button"
        :class="[
          'bg-gray-50 border border-gray-200 rounded-lg p-3 text-left transition-all',
      ...
      >
        <span class="text-[11px] font-medium text-gray-500 block truncate">Draft Penerimaan</span>
      ...
      >
        <span class="text-[11px] font-medium text-gray-500 block truncate">Draft Pengeluaran</span>
        <div class="mt-2 flex items-baseline justify-between">
          <span
      ...
      <component
        ...
        :class="[
          'bg-gray-50 border border-gray-200 rounded-lg p-3 text-left transition-all',
          canNavigate('stock_transfers.view') ? 'hover:bg-amber-50/50 hover:border-amber-300 cursor-pointer group focus:outline-none focus:ring-2 focus:ring-amber-500' : ''
        ]"
        @click="canNavigate('stock_transfers.view') && navigateTo('inventory.transfers')"
      >
        <span class="text-[11px] font-medium text-gray-500 block truncate">Transfer Transit</span>
        <div class="mt-2 flex items-baseline justify-between">
          <span
          ...
          <span
            ...
            class="text-[10px] text-amber-600 font-semibold group-hover:translate-x-0.5 transition-transform"
          >&rarr;</span>
        </div>
      </component>
      ...
      <component
        ...
        :class="[
          'bg-gray-50 border border-gray-200 rounded-lg p-3 text-left transition-all',
          canNavigate('stock_adjustments.view') ? 'hover:bg-indigo-50/50 hover:border-indigo-300 cursor-pointer group focus:outline-none focus:ring-2 focus:ring-indigo-500' : ''
        ]"
        @click="canNavigate('stock_adjustments.view') && navigateTo('inventory.adjustments')"
      >
        <span class="text-[11px] font-medium text-gray-500 block truncate">Draft Penyesuaian</span>
        <div class="mt-2 flex items-baseline justify-between">
          <span
          ...
          <span
            ...
            class="text-[10px] text-indigo-600 font-semibold group-hover:translate-x-0.5 transition-transform"
          >&rarr;</span>
        </div>
      </component>
      ...
      <component
        ...
        :class="[
          'bg-gray-50 border border-gray-200 rounded-lg p-3 text-left transition-all',
          canNavigate('stock_opnames.view') ? 'hover:bg-purple-50/50 hover:border-purple-300 cursor-pointer group focus:outline-none focus:ring-2 focus:ring-purple-500' : ''
        ]"
        @click="canNavigate('stock_opnames.view') && navigateTo('stockOpnames')"
      >
        <span class="text-[11px] font-medium text-gray-500 block truncate">Opname Berlangsung</span>
        <div class="mt-2 flex items-baseline justify-between">
          <span
          ...
          <span
            ...
            class="text-[10px] text-purple-600 font-semibold group-hover:translate-x-0.5 transition-transform"
          >&rarr;</span>
        </div>
      </component>
      ...
      <component
        ...
        :class="[
          'bg-gray-50 border border-gray-200 rounded-lg p-3 text-left transition-all',
          canNavigate('stock_opnames.view') ? 'hover:bg-emerald-50/50 hover:border-emerald-300 cursor-pointer group focus:outline-none focus:ring-2 focus:ring-emerald-500' : ''
        ]"
        @click="canNavigate('stock_opnames.view') && navigateTo('stockOpnames')"
      >
        <span class="text-[11px] font-medium text-gray-500 block truncate">Opname Menunggu Post</span>
        <div class="mt-2 flex items-baseline justify-between">
          <span
          ...
          <span
            v-if="canNavigate('stock_opnames.view')"
            class="text-[10px] text-emerald-600 font-semibold group-hover:translate-x-0.5 transition-transform"
          >&rarr;</span>
        </div>
      </component>
    </div>
