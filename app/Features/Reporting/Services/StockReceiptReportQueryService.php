...
class StockReceiptReportQueryService
{
    ...
    public function getReport(array $allowedLocationIds, array $filters): array
    {
        ...
        $itemsPaginator = $this->repository->getPaginatedStockReceiptReport(
            $allowedLocationIds,
            $filters,
            $sortField,
            $sortDirection,
        ...
        $summary = $this->repository->getStockReceiptReportSummary($allowedLocationIds, $filters);
