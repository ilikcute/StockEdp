...
class StockOpnameReportQueryService
{
    ...
    public function getReport(array $allowedLocationIds, array $filters): array
    {
        ...
        $itemsPaginator = $this->repository->getPaginatedStockOpnameReport(
            $allowedLocationIds,
            $filters,
            $sortField,
            $sortDirection,
        ...
        $summary = $this->repository->getStockOpnameReportSummary($allowedLocationIds, $filters);
