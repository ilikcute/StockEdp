...
class InventoryMovementIntelligenceQuery
{
    ...
    public static function buildSlowMovingBaseQuery(array $targetLocationIds, array $periodInfo, array $filters = []): Builder
    {
        ...
        // Subquery for latest historical movement in the last 365 days before the period.
        // Mempercepat query dengan membatasi agregasi hanya pada pergerakan terbaru.
        $lookbackStart = CarbonImmutable::parse($periodInfo['start_datetime'], 'Asia/Jakarta')
            ->subDays(365)
